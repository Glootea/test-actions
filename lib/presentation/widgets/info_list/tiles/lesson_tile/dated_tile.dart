                              ...
                              SizedBox(
                                  ...
                                  child: Scrollbar(
                                      child: GridView.builder(
                                          ...
                                          shrinkWrap: true,
                                          itemCount:
                                              (widget.datedLessons[widget.innerCount] as DatedLessonSettingEntity)
                                                      .date
                                                      .length +
                                                  1,
            ...
            child: ColoredBox(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      '${(widget.datedLessons[widget.innerCount] as DatedLessonSettingEntity).date.map((e) => DateFormat('dd.MM').format(e))}'
                          .replaceAll('(', '')
                          .replaceAll(')', ''),
