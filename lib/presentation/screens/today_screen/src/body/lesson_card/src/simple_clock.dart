...
class CountDownClock extends StatefulWidget {
  CountDownClock({required this.expireTime, required this.size, required this.onEnd, DateTime? startTime, super.key})
...
class _SimpleClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas
      ..drawLine(center, Offset(hourX, hourY), paint)
      ..drawLine(center, Offset(minuteX, minuteY), paint);
  }
