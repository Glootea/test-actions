...
import 'package:queue/presentation/common_src/initable_cubit_screen_template.dart';
...
class TodayScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InitableCubitScreenTemplate(
      future: TodayScreenCubit.create(context.read<DatabaseService>()),
