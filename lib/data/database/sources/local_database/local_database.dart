...
class LocalDatabase extends _$LocalDatabase {
  ...
  Future<void> _set(StoredValues storedValue, String value) async => into(keyValueStorageTable).insert(
  ...
  Future<void> _clean(StoredValues storedValue) async =>
      (delete(keyValueStorageTable)..where((tbl) => tbl.key.equals(storedValue.name))).go();
