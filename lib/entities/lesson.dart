...
final class LessonSettingEntity {
  ...
  LessonSettingEntity(this.name,
      {this.weeklyLesson, this.datedLessons, this.useWeekly = true});

  LessonSettingEntity copyWith(
      {String? name,
      LessonEntity? weeklyLesson,
      List<WeeklyLessonSettingEntity>? datedLessons,
      bool? useWeekly}) {
    return LessonSettingEntity(name ?? this.name,
        weeklyLesson: weeklyLesson ?? this.weeklyLesson,
...
final class WeeklyLessonSettingEntity {
  ...
  WeeklyLessonSettingEntity copyWith(
      {TimeOfDay? startTime, TimeOfDay? endTime, int? weekday}) {
...
final class DatedLessonSettingEntity {
  ...
  DatedLessonSettingEntity copyWith(
      {TimeOfDay? startTime, TimeOfDay? endTime, DateTime? date}) {
